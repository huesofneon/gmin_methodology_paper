...
{
#read in data-----
mass_data5 <- readRDS(paste0(data_dir,"mass_data_run4_agw.rds"))%>%
  na.omit()
...
saveRDS(modelcoeffs_gmin,paste0(data_dir,"modelcoeffs_gmin_run4.rds"))
saveRDS(df_comb,paste0(data_dir,"df_comb_run4_agw.rds"))
