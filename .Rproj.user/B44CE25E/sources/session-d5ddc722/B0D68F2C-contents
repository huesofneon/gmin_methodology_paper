...
### we changed the one-sided projected area in file 4_LA_Corrections_DK_agw.xlsx to be 
...
LA_transf <- read_xlsx(paste0(raw_data_dir,"4_LA_Corrections_DK_agw.xlsx"))%>%
...
saveRDS(mass_data5,paste0(data_dir,"mass_data_run4_agw.rds"))
